...
docker run -d --name my-container -p 80:8000 --restart unless-stopped -e OPENAI_API_KEY="$${OPENAI_API_KEY}" ${AWS_ACCOUNT_ID}.dkr.ecr.${AWS_REGION}.amazonaws.com/ai-assistant:latest
